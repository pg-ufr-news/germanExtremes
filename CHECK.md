# EXTREMES  
### EXTREME_LANGUAGE  
:white_check_mark: EXTREME_LANGUAGE key exists (de)  
### EXTREME_GH_TOKEN  
...
3. Assign the API key as (new?) organization secret or edit it at https://github.com/organizations/pg-ufr-news/settings/secrets/actions  
   * Name:  **RAPIDAPI_KEY**   
   * Value: **Your key here**   
